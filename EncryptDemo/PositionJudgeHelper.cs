...
namespace EncryptDemo
{
    ...
    {
        static List<Point[]> polygon = new List<Point[]>();
        ...
        private static void InitPolygon()
        {
            polygon.Add(new Point[]{
                ...
                new Point(22.15441, 114.2224),//新增香港校正坐标
        ...
        private static bool IsInsidePolygon(Point[] poly, double x, double y)
        {
            var index = 0;
            var inside = false;
            var prePoint = poly[0];
